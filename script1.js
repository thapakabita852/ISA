      ...
      let startGame = () => {
        document.getElementById("game-status").innerHTML = "Choose";
      ...
      let endGame = (event) => {
        ...
        document.getElementById("game-status").innerHTML = moves["Message"];
        ...
        moveDisplays[1].innerHTML = "Computer's move: " + moveList[parseInt(moves["Computer"])];
      }
      ...
      let resetGame = () => {
        ...
        btns[1].innerHTML = "Scissors";
        btns[1].removeEventListener("click", startGame);
